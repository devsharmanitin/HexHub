...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="container-fluid">
    ...
    <div class="d-flex align-items-center">
      ...
      <div class="dropdown">
        <a
          class="text-reset me-3 dropdown-toggle hidden-arrow" style="font-weight: 600;"
          href="#"
      ...
      <div class="dropdown">
        <a
          class="dropdown-toggle d-flex align-items-center hidden-arrow" style="font-weight: 600;"
          href="#"
        ...
        >
          <li>
            <a class="dropdown-item" href="{{ route('RequestUser') }}" style="font-weight: 600;">My profile</a>
          </li>
          <li>
