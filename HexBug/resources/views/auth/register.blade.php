	...
	<div class="container-fluid h-custom">
		<div class="row d-flex justify-content-center align-items-center h-100">
			<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
				<form action="{{ route('CreateUser') }}" method="post">
					...
					<div class="form-outline mb-3">
						<input type="password" id="form3Example5" class="form-control form-control-lg" name="password_confirmation" placeholder="Enter password" />
			...
			<div class="col-md-9 col-lg-6 col-xl-5">
				<img src="https://img.freepik.com/free-vector/recruit-agent-analyzing-candidates_74855-4565.jpg?w=826&t=st=1699957378~exp=1699957978~hmac=754ae72e09dcd89b7eb4a3003c634d4ce78cb39b9edfba085d42137450db97c6" class="img-fluid" alt="Sample image">
			</div>
